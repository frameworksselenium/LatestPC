...
public class ReinstatePolicy {
	...
	public boolean AddEffectiveDate(String strValue) throws Exception {
		...
		case "Date After Thirty Days": {
			System.out.println("entered in addeffectiveDate:::");
			status = common.SafeAction(Common.o.getObject("edtCan_DateReceived"), SCRCommon.ReturnThirtydaysAfterDate(), "lst");
		}
		}
		return status;
	}
	...
	/**
	 * @function use to click the radio button of reinstatement question as per the
	 *           input
	 * @param obj
	 * @param readCol
	 * @param actionCol
