...
public class ScreenVideoCapture {
	...
	public static void capturedVideoFileName(String sTestName) throws IOException {
		 ...
		 * System.out.println("latest file has been renamed successfully"); } else {
